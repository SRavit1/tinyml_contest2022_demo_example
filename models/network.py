...
class FC_small(nn.Module):
    def __init__(self, full=False, binary=True, first_sparsity=0.8, rest_sparsity=0.9, hid=512, ind=784, align=False, in_bw=4, out_bw=4, weight_bw=4):
        ...
        if full:
            ...
            self.fc1 = binarized_modules.BinarizeLinear(in_bw, out_bw, weight_bw, ind, hid, bias=False)
            self.fc2 = binarized_modules.BinarizeLinear(in_bw, out_bw, weight_bw, hid, 10, bias=False)
        else:
...
class FC_large(nn.Module):
    def __init__(self, full=False, binary=True, first_sparsity=0.8, rest_sparsity=0.9, hid=4096, ind=768, align=False, in_bw=4, out_bw=4, weight_bw=4):
        ...
        if full:
            ...
            self.fc1 = binarized_modules.BinarizeLinear(in_bw, out_bw, weight_bw, ind, hid, bias=False)
            self.fc2 = binarized_modules.BinarizeLinear(in_bw, out_bw, weight_bw, hid, hid, bias=False)
            self.fc3 = binarized_modules.BinarizeLinear(in_bw, out_bw, weight_bw, hid, hid, bias=False)
            self.fc4 = binarized_modules.BinarizeLinear(in_bw, out_bw, weight_bw, hid, 10, bias=False)
        else:
            self.fc1 = binarized_modules.TernarizeLinear(first_sparsity, ind, hid, bias=False, align=align)
...
class CNN_medium(nn.Module):
    ...
    def __init__(self, full=False, binary=True, conv_thres=0.7, fc_thres=0.9, align=False, pad=0, in_bw=4, out_bw=4, weight_bw=4):
        ...
        self.conv1 = binarized_modules.BinarizeConv2d(in_bw, out_bw, weight_bw, 3, 128, kernel_size=3, stride=1, padding=1, bias=False)
        ...
        if full:
            ...
            self.conv1 = binarized_modules.BinarizeConv2d(in_bw, out_bw, weight_bw, 3, 128, kernel_size=3, stride=1, padding=0, bias=False)
            self.conv2 = binarized_modules.BinarizeConv2d(in_bw, out_bw, weight_bw, 128, 128, kernel_size=3, stride=1, padding=0, bias=False)
            self.conv3 = binarized_modules.BinarizeConv2d(in_bw, out_bw, weight_bw, 128, 256, kernel_size=3, stride=1, padding=0, bias=False)
            self.conv4 = binarized_modules.BinarizeConv2d(in_bw, out_bw, weight_bw, 256, 256, kernel_size=3, stride=1, padding=0, bias=False)
            self.conv5 = binarized_modules.BinarizeConv2d(in_bw, out_bw, weight_bw, 256, 512, kernel_size=3, stride=1, padding=0, bias=False)
            self.conv6 = binarized_modules.BinarizeConv2d(in_bw, out_bw, weight_bw, 512, 512, kernel_size=3, stride=1, padding=0, bias=False)
            self.conv7 = binarized_modules.BinarizeConv2d(in_bw, out_bw, weight_bw, 512, 10, kernel_size=4, padding=0, bias=False)
            self.fc1 = binarized_modules.BinarizeLinear(in_bw, out_bw, weight_bw, 1024, 1024, bias=False)
        else:
            self.conv1 = binarized_modules.BinarizeConv2d(in_bw, out_bw, weight_bw, 3, 128, kernel_size=3, stride=1, padding=0, bias=False)
...
class CNN_large(nn.Module):
    ...
    def __init__(self, full=False, binary=True, conv_thres=0.7, fc_thres=0.9, align=False, pad=0, in_bw=4, out_bw=4, weight_bw=4):
        ...
        if full:
            ...
            self.conv5 = binarized_modules.BinarizeConv2d(in_bw, out_bw, weight_bw, 256, 512, kernel_size=3, stride=1, padding=0, bias=False)
            self.conv6 = binarized_modules.BinarizeConv2d(in_bw, out_bw, weight_bw, 512, 512, kernel_size=3, stride=1, padding=0, bias=False)
            self.conv7 = binarized_modules.BinarizeConv2d(in_bw, out_bw, weight_bw, 512, 1024, kernel_size=4, padding=0, bias=False)
            self.fc1 = binarized_modules.BinarizeLinear(in_bw, out_bw, weight_bw, 1024, 1024, bias=False)
            self.fc2 = binarized_modules.BinarizeLinear(in_bw, out_bw, weight_bw, 1024, 10, bias=False)
        else:
            self.conv1 = binarized_modules.BinarizeConv2d(in_bw, out_bw, weight_bw, 3, 128, kernel_size=3, stride=1, padding=0, bias=False)
            self.conv2 = binarized_modules.TernarizeConv2d(conv_thres, 128, 128, kernel_size=3, padding=0, bias=False, align=align)
            self.conv3 = binarized_modules.TernarizeConv2d(conv_thres, 128, 256, kernel_size=3, padding=0, bias=False, align=align)
...
class CNN_tiny(nn.Module):
    ...
    def __init__(self, full=False, binary=True, conv_thres=0.7, fc_thres=0.9, align=False, in_bw=4, out_bw=4, weight_bw=4):
        ...
        if full:
            ...
            self.conv1 = binarized_modules.BinarizeConv2d(in_bw, out_bw, weight_bw, 1, 32, kernel_size=5, stride=1, padding=0, bias=False)
            self.conv2 = binarized_modules.BinarizeConv2d(in_bw, out_bw, weight_bw, 32, 32, kernel_size=5, stride=1, padding=0, bias=False)
            self.fc1 = binarized_modules.BinarizeConv2d(in_bw, out_bw, weight_bw, 32, 10, kernel_size=4, padding=0, bias=False)
        else:
            self.conv1 = binarized_modules.BinarizeConv2d(in_bw, out_bw, weight_bw, 1, 32, kernel_size=5, stride=1, padding=0, bias=False)
